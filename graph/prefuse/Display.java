 ...
 * 
 * <p>Additionally, each Display instance also supports use of a text editorf
...
public class Display extends JComponent {
    ...
    public Display(Visualization visualization, Predicate predicate) {
        ...
        m_transact = new TransformActivity(getVisualization());
    }
    ...
    public synchronized void zoom(double xScale, double yScale) {
    ...
    private class TransformActivity extends Activity {
        ...
        public TransformActivity(Visualization vis) {
            super(vis, 2000,20,0);
            src = new double[6];
            dst = new double[6];

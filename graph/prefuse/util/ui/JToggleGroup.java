...
public class JToggleGroup extends JPanel {
    ...
    protected ListModel<Object>          m_data;
    ...
    public JToggleGroup(int type, Object[] data) {
        this(type, new DefaultListModel<Object>(), 
                new DefaultListSelectionModel());
        
        DefaultListModel<Object> model = (DefaultListModel<Object>)m_data;
     ...
     */
    public JToggleGroup(int type, ListModel<Object> data) {
     ...
     */
    public JToggleGroup(int type, ListModel<Object> data, ListSelectionModel selection)
    {

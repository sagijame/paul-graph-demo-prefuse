...
public class DataLib {
     ...
     * order of values
     */
    public static Map<Object, Integer> ordinalMap(Iterator<?> tuples, String field) {
     ...
     * order of values
     */
    public static Map<Object, Integer> ordinalMap(Iterator<?> tuples, String field, Comparator<Object> cmp)
    {
     ...
     */
    public static Tuple min(Iterator<Object> tuples, String field) {
     ...
     * @return the Tuple with the minimum data field value
     */
    public static Tuple min(Iterator<Object> tuples, String field, Comparator<Object> cmp) {
        Tuple t = null, tmp;
        Object min = null;
        if ( tuples.hasNext() ) {
            t = (Tuple)tuples.next();
	...
	public static Tuple min(TupleSet tuples, String field, Comparator<Object> cmp) {
        if ( tuples instanceof Table ) {
            ...
            return min((Iterator<Object>) tuples.tuples(), field, cmp);
        }
    }
     ...
     * @return the Tuple with the maximum data field value
     */
    public static Tuple max(Iterator<?> tuples, String field, Comparator<Object> cmp) {
        Tuple t = null, tmp;
        Object min = null;
        if ( tuples.hasNext() ) {
            t = (Tuple)tuples.next();
     ...
     * @return the Tuple with the median data field value
     */
    public static Tuple median(Iterator<?> tuples, String field, Comparator<Object> cmp) {

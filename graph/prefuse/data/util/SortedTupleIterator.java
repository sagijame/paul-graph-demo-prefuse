 ...
 */
public class SortedTupleIterator implements Iterator<Object> {
     ...
     */
    public SortedTupleIterator(Iterator<?> iter, Comparator<Tuple> c) {
        this(iter, 128, c);
    }
     ...
     * @param c the comparator to use for sorting
     */
    public SortedTupleIterator(Iterator<?> iter, int size, Comparator<Tuple> c) {
     ...
     * @param c the comparator to use for sorting
     */
    public void init(Iterator<?> iter, Comparator<Tuple> c) {
        m_tuples.clear();
        m_cmp = c;

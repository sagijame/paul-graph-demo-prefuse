...
public class ZoomingPanControl extends ControlAdapter {
     ...
     */
    public ZoomingPanControl(Visualization vis) {
        this(vis, true);
    }
     ...
     */
    public ZoomingPanControl(Visualization vis, boolean repaint) {
    	m_vis = vis;
    	update = new UpdateActivity(vis);
        finish = new FinishActivity(vis);
    ...
    private class UpdateActivity extends Activity {
        ...
        public UpdateActivity(Visualization vis) {
            super(vis, -1,15,0);
        }
    ...
    private class FinishActivity extends Activity {
        ...
        public FinishActivity(Visualization vis) {
            super(vis, 1500,15,0);

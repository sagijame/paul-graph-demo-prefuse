...
public class ActivityManager extends Thread {
     ...
     */
    public ActivityManager(Visualization vis) {
     ...
     */
    public void schedule(Activity a) {
        _schedule(a, a.getStartTime());
    }
     ...
     * @param a the Activity to schedule
     */
    public void scheduleNow(Activity a) {
        _schedule(a, System.currentTimeMillis());
    }
     ...
     */
    public void scheduleAt(Activity a, long startTime) {
        _schedule(a, startTime);
    }
     ...
     */
    public void scheduleAfter(Activity before, Activity after) {
        _scheduleAfter(before, after);
    }
     ...
     * @param after the Activity to run immediately after the first
     */
    public void alwaysScheduleAfter(Activity before, Activity after) {
        _alwaysScheduleAfter(before, after);
    }

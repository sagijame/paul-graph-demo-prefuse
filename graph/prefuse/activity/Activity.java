...
public abstract class Activity {
     ...
     */
    public Activity(Visualization vis, long duration) {
        this(vis, duration, DEFAULT_STEP_TIME);
    }
     ...
     * @see prefuse.activity.Activity#Activity(long, long, long)
     */
    public Activity(Visualization vis, long duration, long stepTime) {
        this(vis, duration, stepTime, System.currentTimeMillis());
    }
     ...
     */
    public Activity(Visualization vis, long duration, long stepTime, long startTime) {
    	m_vis       = vis;
     ...
     */
    public void run() {
        m_vis.getActivityManager().scheduleNow(this);
    }
    ...
    public void runAt(long startTime) {
        m_vis.getActivityManager().scheduleAt(this,startTime);
    }
    ...
    public void runAfter(Activity before) {
        m_vis.getActivityManager().scheduleAfter(before, this);
    }
    ...
    public void alwaysRunAfter(Activity before) {
        m_vis.getActivityManager().alwaysScheduleAfter(before, this);
    }
     ...
     */
    public void cancel(Visualization vis) {
    /*
     ...
     */
    	//m_vis.getActivityManager().cancelActivity(this);
    	vis.getActivityManager().cancelActivity(this);
    }

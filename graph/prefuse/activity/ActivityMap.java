...
public class ActivityMap {
     ...
     */
    public ActivityMap(Visualization vis) {
        this(vis, null);
    }
     ...
     */
    public ActivityMap(Visualization vis, ActivityMap parent) {
    	m_vis = vis;
    ...
    public Activity runAt(String key, long time) {
        Activity a = get(key);
        if ( a != null )
            m_vis.getActivityManager().scheduleAt(a,time);
        return a;
    }    
    ...
    public Activity run(String key) {
        Activity a = get(key);
        if ( a != null )
            m_vis.getActivityManager().scheduleNow(a);
        return a;
    }
    ...
    public Activity runAfter(String beforeKey, String afterKey) {
        ...
        if ( before != null && after != null )
            m_vis.getActivityManager().scheduleAfter(before, after);
        return after;
    }
    ...
    public Activity alwaysRunAfter(String beforeKey, String afterKey) {
        ...
        Activity after  = get(afterKey);
        if ( before != null && after != null )
            m_vis.getActivityManager().alwaysScheduleAfter(before, after);
        return after;
    }

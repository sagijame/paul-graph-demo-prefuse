...
public class Visualization {
    ...
    public Visualization(String name) {   
    	m_manager = new ActivityManager(this);
        m_actions = new ActivityMap(this);
        ...
        m_manager.setName(name);
    }
    
    public ActivityManager getActivityManager() { return m_manager; }
    ...
    public Graph getGraph(String group) {
    	return mGraphs.get(group); 
    }

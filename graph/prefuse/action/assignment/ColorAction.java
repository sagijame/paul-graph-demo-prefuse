...
public class ColorAction extends EncoderAction {
     ...
     */
    public ColorAction(Visualization vis, String group, String field) {
        super(vis, group);
        setField(field);
    }
     ...
     */
    public ColorAction(Visualization vis, String group, String field, int color) {
     ...
     * @param field the color field assigned by this Action
     */
    public ColorAction(Visualization vis, String group, Predicate filter, String field) {
     ...
     * @param color the default color value assigned by this ColorAction
     */
    public ColorAction(Visualization vis, String group, Predicate filter, String field, int color)
    {
    	this(vis, group, filter, field);

...
public class StrokeAction extends EncoderAction {
     ...
     */
    public StrokeAction(Visualization vis) {
        super(vis);
    }
     ...
     */
    public StrokeAction(Visualization vis, String group) {
        super(vis, group);
    }
     ...
     */
    public StrokeAction(Visualization vis, String group, BasicStroke defaultStroke) {
        super(vis, group);

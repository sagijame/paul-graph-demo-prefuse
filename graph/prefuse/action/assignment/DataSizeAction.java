...
public class DataSizeAction extends SizeAction {
     ...
     */
    public DataSizeAction(Visualization vis, String group, String field) {
        super(vis, group, NO_SIZE);
        m_dataField = field;
    }
     ...
     */
    public DataSizeAction(Visualization vis, String group, String field, int bins) {
        this(vis, group, field, bins, Constants.LINEAR_SCALE);
    }
     ...
     */
    public DataSizeAction(Visualization vis, String group, String field, int bins, int scale) {
        super(vis, group, NO_SIZE);
        m_dataField = field;
        setScale(scale);
        setBinCount(bins);

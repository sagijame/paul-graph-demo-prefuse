...
public class DataShapeAction extends ShapeAction {
     ...
     */
    public DataShapeAction(Visualization vis, String group, String field) {
        super(vis, group, NO_SHAPE);
        m_dataField = field;
    }
     ...
     */
    public DataShapeAction(Visualization vis, String group, String field, int[] palette) {
        super(vis, group, NO_SHAPE);
        m_dataField = field;
        m_palette = palette;
    }

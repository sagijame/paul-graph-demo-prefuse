...
public class SquarifiedTreeMapLayout extends TreeLayout {
     ...
     */
    public SquarifiedTreeMapLayout(Visualization vis, String group) {
        this(vis, group, 0);
    }
     ...
     * @param group the data group to layout. Must resolve to a Graph instance.
     */
    public SquarifiedTreeMapLayout(Visualization vis, String group, double frame) {
        super(vis, group);
        setFrameWidth(frame);
    }
    ...
    private void squarify(List<?> c, List<VisualItem> row, double w, Rectangle2D r) {

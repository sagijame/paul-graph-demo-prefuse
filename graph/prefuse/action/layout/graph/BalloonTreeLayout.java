 ...
 * 
 * <p>The algorithm used is that of G. Melan占퐊 and I. Herman from their
 * research paper Circular Drawings of Rooted Trees, Reports of the Centre for 
 * Mathematics and Computer Sciences, Report Number INS占�17, 1998.</p>
 *
...
public class BalloonTreeLayout extends TreeLayout {
     ...
     * or Tree instance.
     */
    public BalloonTreeLayout(Visualization vis, String group) {
        this(vis, group, 2);
    }
     ...
     */
    public BalloonTreeLayout(Visualization vis, String group, int minRadius) {
        super(vis, group);

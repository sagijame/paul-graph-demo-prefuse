 ...
 * 
 * <p>The algorithm used is that of Christoph Buchheim, Michael J�ger,
...
public class NodeLinkTreeLayout extends TreeLayout {
     ...
     */
    public NodeLinkTreeLayout(Visualization vis, String group) {
        super(vis, group);
     ...
     */
    public NodeLinkTreeLayout(Visualization vis, String group, int orientation,

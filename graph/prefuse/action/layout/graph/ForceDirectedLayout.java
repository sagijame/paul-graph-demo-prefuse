...
public class ForceDirectedLayout extends Layout {
     ...
     */
    public ForceDirectedLayout(Visualization vis, String graph)
    {
        this(vis, graph, false, false);
    }
     ...
     */
    public ForceDirectedLayout(Visualization vis, String group, boolean enforceBounds)
    {
        this(vis, group, enforceBounds, false);
    }
     ...
     * layout is computed.
     */
    public ForceDirectedLayout(Visualization vis, String group,
    ...
    public ForceDirectedLayout(Visualization vis, String group,
        ...
        this(vis, group, fsim, enforceBounds, false);
    }
     ...
     * layout is computed.
     */
    public ForceDirectedLayout(Visualization vis, String group, ForceSimulator fsim,
            boolean enforceBounds, boolean runonce)
    {
        super(vis, group);
        m_nodeGroup = PrefuseLib.getGroupName(group, Graph.NODES);
...
//                }
    ...
    protected void initSimulator(ForceSimulator fsim) {     
        ...
        TupleSet ts = getVisualization().getGroup(m_nodeGroup);
        if ( ts == null ) return;
        try {
        ...
        if ( m_edgeGroup != null ) {
            iter = getVisualization().visibleItems(m_edgeGroup);
            while ( iter.hasNext() ) {

...
public abstract class Layout extends GroupAction {
     ...
     * Create a new Layout.
     */
    public Layout(Visualization vis) {
        super(vis);
    }
     ...
     */
    public Layout(Visualization vis, String group) {
        super(vis, group);
    }

    public Layout(Visualization vis, String group, long duration) {
        super(vis, group, duration);
    }
    ...
    public Rectangle2D getLayoutBounds() {
        ...
        if ( getVisualization() != null && getVisualization().getDisplayCount() > 0 )
        {

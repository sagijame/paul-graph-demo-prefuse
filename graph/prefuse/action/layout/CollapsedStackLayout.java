...
public class CollapsedStackLayout extends Layout {
     ...
     */
    public CollapsedStackLayout(Visualization vis, String group) {
        this(vis, group, PolygonRenderer.POLYGON);
    }
     ...
     */
    public CollapsedStackLayout(Visualization vis ,String group, String field) {
        super(vis, group);
        m_polyField = field;
    }
    ...
    public void run(double frac) {
        ...
        Iterator<?> iter = ((Table)getVisualization().getGroup(m_group)).tuplesReversed();
        while ( iter.hasNext() ) {

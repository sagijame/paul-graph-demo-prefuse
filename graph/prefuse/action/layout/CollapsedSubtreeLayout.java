...
public class CollapsedSubtreeLayout extends Layout {
     ...
     * visibility settings).
     */
    public CollapsedSubtreeLayout(Visualization vis, String group) {
        this(vis, group, Constants.ORIENT_CENTER);
    }
     ...
     */
    public CollapsedSubtreeLayout(Visualization vis, String group, int orientation) {
        super(vis, group);

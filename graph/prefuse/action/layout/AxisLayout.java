...
public class AxisLayout extends Layout {
     ...
     */
    public AxisLayout(Visualization vis, String group, String field) {
        super(vis, group);
        m_field = field;
    }
     ...
     */
    public AxisLayout(Visualization vis, String group, String field, int axis) {
        this(vis, group, field);
        setAxis(axis);
    }
     ...
     * to layout.
     */
    public AxisLayout(Visualization vis, String group, String field, int axis, Predicate filter) {
        this(vis, group, field, axis);
        setFilter(filter);
    }
    ...
    protected void numericalLayout(TupleSet ts) {
        ...
        Iterator<?> iter = getVisualization().items(m_group, m_filter);
        while ( iter.hasNext() ) {

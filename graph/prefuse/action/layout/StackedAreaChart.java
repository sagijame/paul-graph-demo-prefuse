...
public class StackedAreaChart extends Layout {
     ...
     */
    public StackedAreaChart(Visualization vis, String group, String field, String[] columns) {
        this(vis, group, field, columns, 1.0);
    }
...
//    }
    ...
    public void run(double frac) {
        ...
        Table t = (Table)getVisualization().getGroup(m_group);

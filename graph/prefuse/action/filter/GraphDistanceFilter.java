...
public class GraphDistanceFilter extends GroupAction {
     ...
     * Action is run.
     */
    public GraphDistanceFilter(Visualization vis, String group) {
        this(vis, group, 1);
    }
     ...
     * visible.
     */
    public GraphDistanceFilter(Visualization vis, String group, int distance) {
     ...
     * visible.
     */
    public GraphDistanceFilter(Visualization vis, String group, String sources, int distance)
    {
        super(vis, group);
        m_sources = sources;
        m_distance = distance;
    ...
    public void run(double frac) {
        ...
        TupleSet src = getVisualization().getGroup(m_sources);

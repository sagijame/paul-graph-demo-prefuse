...
public class BifocalDistortion extends Distortion {
     ...
     */
    public BifocalDistortion(Visualization vis) {
        this(vis, 0.1,3);
    }
     ...
     */
    public BifocalDistortion(Visualization vis, double range, double mag) {
        this(vis, range,mag,range,mag);
    } //
     ...
     *  in the focal area
     */
    public BifocalDistortion(Visualization vis, double xrange, double xmag, 

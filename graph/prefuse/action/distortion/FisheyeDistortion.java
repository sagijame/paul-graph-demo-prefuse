...
public class FisheyeDistortion extends Distortion {
     ...
     */
    public FisheyeDistortion(Visualization vis) {
        this(vis, 4);
    }
     ...
     */
    public FisheyeDistortion(Visualization vis, double dfactor) {
        this(vis, dfactor, dfactor);
    }
     ...
     */
    public FisheyeDistortion(Visualization vis, double xfactor, double yfactor) {
        super(vis);
        dx = xfactor;
        dy = yfactor;
        m_distortX = dx > 0;

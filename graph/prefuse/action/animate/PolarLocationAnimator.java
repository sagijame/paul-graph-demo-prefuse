...
public class PolarLocationAnimator extends ItemAction {
     ...
     */
    public PolarLocationAnimator(Visualization vis) {
        super(vis);
    }
     ...
     */
    public PolarLocationAnimator(Visualization vis, String group) {
        super(vis, group);
    }
     ...
     */
    public PolarLocationAnimator(Visualization vis, String group, String linearGroup) {
        super(vis, group);

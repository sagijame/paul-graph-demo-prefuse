...
public class AxisLabelAnimator extends ItemAction {
     ...
     */
    protected AxisLabelAnimator(Visualization vis) {
        super(vis);
    }    
     ...
     */
    public AxisLabelAnimator(Visualization vis, String group) {
        super(vis, group);
    }
    ...
    private void setup() {
        ...
        items = getVisualization().items(m_group, StartVisiblePredicate.TRUE);
        while ( items.hasNext() ) {
            VisualItem item = (VisualItem) items.next();
    ...
    private void finish() {
        ...
        Iterator<?> items = getVisualization().items(m_group, StartVisiblePredicate.TRUE);
        while ( items.hasNext() ) {
            VisualItem item = (VisualItem) items.next();
            if ( !item.isEndVisible() ) {

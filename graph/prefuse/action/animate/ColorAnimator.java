...
public class ColorAnimator extends ItemAction {
     ...
     */
    public ColorAnimator(Visualization vis) {
        super(vis);
     ...
     */
    public ColorAnimator(Visualization vis, String group) {
        super(vis, group);
        setColorFields(DEFAULTS);
    }
     ...
     */
    public ColorAnimator(Visualization vis, String group, String field) {
        super(vis, group);
     ...
     */
    public ColorAnimator(Visualization vis, String group, String[] fields) {
        super(vis, group);

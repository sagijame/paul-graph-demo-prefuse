...
public class AggregateDemo  extends Display {
    ...
    public AggregateDemo() {
        ...
        super(new Visualization("AggregateDemo"));
        mVis = getVisualization();
        ...
        ColorAction aFill = new DataColorAction(mVis, AGGR, "id",
    ...
    private void initDataGroups() {
        ...
        mVis.setValue(NODES, null, VisualItem.SHAPE,
...
class AggregateLayout extends Layout {
    ...
    public void run(double frac) {
        ...
        AggregateTable aggr = (AggregateTable)getVisualization().getGroup(m_group);
        ...
        Iterator<?> aggrs = getVisualization().visibleItems(m_group);
        while ( aggrs.hasNext() ) {

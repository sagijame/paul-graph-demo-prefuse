...
public class TreeMap extends Display {
    ...
    public TreeMap(Tree t, String label) {
        super(new Visualization("TreeMap"));
        ...
        // border colors
        final ColorAction borderColor = new BorderColorAction(m_vis, treeNodes);
        final ColorAction fillColor = new FillColorAction(m_vis, treeNodes);
        
        // color settings
        ActionList colors = new ActionList(m_vis);
        ...
        ActionList layout = new ActionList(m_vis);
        layout.add(new SquarifiedTreeMapLayout(m_vis, tree));
        layout.add(new LabelLayout(m_vis, labels));
        layout.add(colors);
        layout.add(new RepaintAction(m_vis));
    ...
    public static class BorderColorAction extends ColorAction {
        ...
        public BorderColorAction(Visualization vis, String group) {
            super(vis, group, VisualItem.STROKECOLOR);
        }
    ...
    public static class FillColorAction extends ColorAction {
        ...
        public FillColorAction(Visualization vis, String group) {
    ...
    public static class LabelLayout extends Layout {
        public LabelLayout(Visualization vis, String group) {
            super(vis, group);
        }
        public void run(double frac) {
            Iterator<?> iter = getVisualization().items(m_group);
            while ( iter.hasNext() ) {

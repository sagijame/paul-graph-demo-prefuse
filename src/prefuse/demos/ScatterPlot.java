...
public class ScatterPlot extends Display {
    ...
    public ScatterPlot(Table t, String xfield, String yfield, String sfield) {
        super(new Visualization("ScatterPlot"));
        ...
        // set up the actions
        AxisLayout x_axis = new AxisLayout(m_vis, group, xfield, 
                Constants.X_AXIS, VisiblePredicate.TRUE);
        m_vis.putAction("x", x_axis);
        
        AxisLayout y_axis = new AxisLayout(m_vis, group, yfield, 
                Constants.Y_AXIS, VisiblePredicate.TRUE);
        m_vis.putAction("y", y_axis);

        ColorAction color = new ColorAction(m_vis, group, 
                VisualItem.STROKECOLOR, ColorLib.rgb(100,100,255));
        m_vis.putAction("color", color);
        
        DataShapeAction shape = new DataShapeAction(m_vis, group, sfield);
        ...
        if ( sfield != null )
            draw.add(shape);
        draw.add(color);
        draw.add(new RepaintAction(m_vis));
            ...
            final String xfield, final String yfield, final String sfield)
    {
        ...
        final JComboBox<?> xcb = new JComboBox<Object>(colnames);
        ...
        final JComboBox<?> ycb = new JComboBox<Object>(colnames);
        ...
        final JComboBox<?> scb = new JComboBox<Object>(colnames);

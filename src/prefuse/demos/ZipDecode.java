...
public class ZipDecode extends Display implements Constants {
    ...
    public ZipDecode(final Table t) {
        super(new Visualization("ZipDecode"));
        ...
        layout.add(new AxisLayout(m_vis, DATA, "lat", Y_AXIS));
        layout.add(new AxisLayout(m_vis, DATA, "lon", X_AXIS));
        ...
        final Action update = new ZipColorAction(m_vis, FOCUS);
        ...
        ActionList animate = new ActionList(m_vis, 200);
        animate.add(new ColorAnimator(m_vis, FOCUS, VisualItem.FILLCOLOR));
        animate.add(new ColorAnimator(m_vis, LABELS, VisualItem.TEXTCOLOR));
        ...
        ActionList resize = new ActionList(m_vis, 1500);
        resize.setPacingFunction(new SlowInSlowOutPacer());
        resize.add(new LocationAnimator(m_vis, DATA));
        resize.add(new LocationAnimator(m_vis, LABELS));
        resize.add(new RepaintAction(m_vis));
    ...
    public static class ZipColorAction extends ColorAction {
        public ZipColorAction(Visualization vis, String group) {

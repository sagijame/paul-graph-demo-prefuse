...
public class GraphView extends JPanel {
    ...
    public GraphView(Graph g, String label) {
        ...
        m_vis = new Visualization("GraphView");
        ...
        int hops = 30;
        final GraphDistanceFilter filter = new GraphDistanceFilter(m_vis, graph, hops);

        ColorAction fill = new ColorAction(m_vis, nodes, 
                VisualItem.FILLCOLOR, ColorLib.rgb(200,200,255));
        fill.add(VisualItem.FIXED, ColorLib.rgb(255,100,100));
        fill.add(VisualItem.HIGHLIGHT, ColorLib.rgb(255,200,125));
        
        ActionList draw = new ActionList(m_vis);
        draw.add(filter);
        draw.add(fill);
        draw.add(new ColorAction(m_vis, nodes, VisualItem.STROKECOLOR, 0));
        draw.add(new ColorAction(m_vis, nodes, VisualItem.TEXTCOLOR, ColorLib.rgb(0,0,0)));
        draw.add(new ColorAction(m_vis, edges, VisualItem.FILLCOLOR, ColorLib.gray(200)));
        draw.add(new ColorAction(m_vis, edges, VisualItem.STROKECOLOR, ColorLib.gray(200)));
        
        ActionList animate = new ActionList(m_vis, Activity.INFINITY);
        animate.add(new ForceDirectedLayout(m_vis, graph));
        animate.add(fill);
...
//        opanel.add(overview);
    ...
    public static class OpenGraphAction extends AbstractAction {
        ...
        public static String getLabel(Component c, Graph g) {
            ...
            final JList<?> list = new JList<Object>(names);
